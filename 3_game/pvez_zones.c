...
class PVEZ_Zones : Managed {
	...
	void LoadDefaultZones() {
		...
		if (worldName == "chernarusplus") {
			...
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 10447,	5969,	"Staroye", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 10227,	4016,	"Topolka Dam", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 10461,	9142,	"Gorka-Dubrovka crossing", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 11963,	12490,	"Krasnostav Airstrip", 150, true));
			...
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 7862,	14688,	"Troitskoye military base", 700, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 7082,	14531,	"Kamensk mining site", 100, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 7088,	12715,	"military camp between Severograd and Ratnoye", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4948,	12991,	"Zaprudnoye", 200, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 3634,	14929,	"Grozovoy military", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 1576,	14000,	"Tisy military base", 600, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4042,	11751,	"The tower near North-West Airfield", 400, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4491,	10358,	"North-West Airfield", 1100, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4532,	8295,	"VMC military base", 250, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 331,	9367,	"Tri Kresta Gas station", 200, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 1154,	7242,	"over the hill to the West of Myshkino", 200, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 2696,	6755,	"on the road between Pustoshka and Sosnovka", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 2146,	3452,	"Pavlovo military base", 350, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 758,	1876,	"on the coast of Tihiy Zaliv", 150, true));
		...
		// Livonia zones:
			...
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 2157,	10967,	"Military Area near Castle", 450, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 3917,	10212,	"Gliniska Airstrip", 600, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 8109,	10889,	"Military Area near Krsnik", 600, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 7901,	9857,	"Krsnik Military Area", 400, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 9836,	8555,	"Borek", 300, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 11344,	10048,	"Hunting Area near Sitnik", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 6434,	8173,	"Nidek Military Area", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 5520,	8773,	"Kona Prison", 200, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4422,	6697,	"Muratyn Military Area", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4573,	6397,	"Muratyn Destroyed Area", 400, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 7454,	6164,	"Radunin Quaratine Area", 600, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 9026,	6624,	"Lembork Military Area", 200, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 9903,	3799,	"Military Area near Wrzeszcz", 400, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 8915,	2041,	"Rodzanica Military Area", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4939,	2146,	"Swarog Military Area", 800, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 7478,	2718,	"Military Area to SE of Nadbor", 600, true));
		}
		// Namalsk zones:
		else if (worldName == "namalsk") {
			Print("PVEZ :: The server is hosting Namalsk map. Creating default zones for Namalsk.");
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4831,	10841,	"Military BK-M06", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4406,	10739,	"Military BK-T07", 100, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 5566,	9974,	"Sebjan reservour pass 1", 400, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 6185,	10034,	"Sebjan reservour pass 2", 400, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 6801,	9958,	"Sebjan reservour pass 3", 400, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 3941,	10003,	"Military BK-T08", 200, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 5167,	8962,	"Refugee camp", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4074,	9234,	"Military BK-T12", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4982,	6548,	"Athena-2", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 4161,	6646,	"Military BK-L01", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 3405,	6734,	"Military BK-L02", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 5992,	6632,	"Military BK-L16", 150, true));
			staticZones.Insert(new ref PVEZ_Zone(PVEZ_ZONE_TYPE_STATIC, 1230,	11836,	"Bering outpost", 200, true));
		}
		else {
